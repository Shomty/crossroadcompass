    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuroraCanvas.useEffect": ()=>{
            ...
            const colorStopsArray = colorStops.map({
                "AuroraCanvas.useEffect.colorStopsArray": (hex)=>{
            ...
            }["AuroraCanvas.useEffect.colorStopsArray"]);
            ...
            let animateId = 0;
            const update = {
                "AuroraCanvas.useEffect.update": (t)=>{
                    ...
                    if (program) {
                        ...
                        program.uniforms.uColorStops.value = stops.map({
                            "AuroraCanvas.useEffect.update": (hex)=>{
                                const c = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ogl$2f$src$2f$math$2f$Color$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Color"](hex);
                                return [
                                    c.r,
                                    c.g,
...
_s(AuroraCanvas, "H3hEXxgRK/TFJBuH98B1fA30BZI=");
_c = AuroraCanvas;
var _c;
...
//# sourceMappingURL=components_5a1a6cea._.js.map