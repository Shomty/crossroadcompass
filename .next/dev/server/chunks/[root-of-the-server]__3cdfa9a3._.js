...
"[project]/app/api/insights/dasha/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST() {
    ...
    const now = new Date();
    const maha = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].dasha.findFirst({
        where: {
            userId,
            level: "MAHADASHA",
            startDate: {
    ...
    if (!maha) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        insight: null
    });
    if (!__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$env$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["env"].GEMINI_API_KEY) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        insight: null
    });
    const antar = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].dasha.findFirst({
        where: {
            userId,
            level: "ANTARDASHA",
            startDate: {
    ...
    const antarName = antar ? (antar.planetName.split("/")[1] ?? antar.planetName).charAt(0).toUpperCase() + (antar.planetName.split("/")[1] ?? antar.planetName).slice(1) : null;
    const prompt = [
    ...
    try {
        const genAI = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$google$2f$generative$2d$ai$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["GoogleGenerativeAI"](__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$env$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["env"].GEMINI_API_KEY);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3cdfa9a3._.js.map