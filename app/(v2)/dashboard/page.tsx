 ...
 * Premium V2 Dashboard — A/B test at /v2/dashboard
 * Same data as original /dashboard but with luxury visual treatment.
 */
  ...
  return (
    <div className="v2-content">
      ...
      <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", marginBottom: 36, gap: 20, flexWrap: "wrap" }}>
        <div>
          <div style={{
            ...
            color: "var(--v2-faint)", marginBottom: 8,
          }}>
            Personal Navigation · Premium
          </div>
          <h1 style={{
            fontFamily: "'Playfair Display', serif",
            fontSize: "clamp(26px, 3.2vw, 38px)",
            fontWeight: 400, letterSpacing: "0.005em",
            color: "var(--v2-moon)", lineHeight: 1.1, margin: 0,
          }}>
            Good {timeOfDay},{" "}
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10, flexShrink: 0 }}>
          ...
          <Link href="/settings" style={{
            ...
            color: "var(--v2-faint)", textDecoration: "none",
          ...
          <Link href="/report" style={{
            ...
            color: "var(--v2-gold)", textDecoration: "none",
      ...
      <div className="v2-grid">
        ...
        {/* 2. Current Dasha — 1 col flip card */}
